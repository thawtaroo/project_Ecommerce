				...
				<div class="summary">
					<div class="order-summary">
						...
						@if(Session::has('coupon'))
							<p class="summary-info"><span class="title">Dicount({{ Session::get('coupon') ['code']}}) <a href="#" wire:click.prevent= "removeCoupon"><i class="fa fa-times text-danger"></i></a></span><b class="index">- {{ number_format($discount ,1)}} MMK</b></p>
							<p class="summary-info"><span class="title">Subtotal with Discount </span><b class="index">{{ number_format($subtotalAfterDiscount,1) }} MMK</b></p>
							<p class="summary-info"><span class="title">Tax ({{ config('cart.tax') }}%)</span><b class="index">{{ number_format($taxAfterDiscount,1) }} MMK</b></p>							
							<p class="summary-info total-info "><span class="title">Total</span><b class="index">{{ number_format($totalAfterDiscount,0) }} MMK</b></p>
						@else
							<p class="summary-info"><span class="title">Tax</span><b class="index">{{ Cart::instance('cart')->tax() }} MMK</b></p>
								...
								<div class="summary-item">
									<form wire:submit.prevent="applyCouponCode">
										...
										@if(Session::has('coupon_massage'))
											<div class="alert alert-danger" role="danger">{{ Session::get('coupon_massage') }}</div>
										@endif
										<p class="row-in-form">
