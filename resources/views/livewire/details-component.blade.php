					...
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
							...
							<div class="wrap-price">
								<span class="product-price">MMk {{ $product->sale_price}}</span>
								<del><span class="product-price regprice">MMK {{ $product->regular_price }}</span></del>
							</div>
							@else
													...
													<div id="comment-20" class="comment_container"> 
														...
														<div class="comment-text">
															<div class="star-rating">
																<span class="width-{{ $orderItem->review->rating * 20 }}-percent">Rated <strong class="rating">{{ $orderItem->review }}</strong> out of 5</span>
															</div>
															<p class="meta"> 
